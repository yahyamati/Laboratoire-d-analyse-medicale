...
public class Chart extends javax.swing.JPanel {
    ...
    private final int seriesSize = 250;
    private final int seriesSpace = 100;
    ...
    public void addLegend(String name, Color color) {
        ...
        refreshChart();  // Refresh to update legend display
    }
    ...
    public void addData(ModelChart data) {
        ...
        refreshChart();  // Refresh to update chart display
    }

    public void refreshChart() {
        blankPlotChart.revalidate();
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(213, 234, 255));

        blankPlotChart.setBackground(new java.awt.Color(213, 234, 255));
        blankPlotChart.setForeground(new java.awt.Color(0, 0, 0));

        panelLegend.setBackground(new java.awt.Color(213, 234, 255));
